...
namespace FunWithStrings
{
    class Program
    {
        ...
        static void BasicStringFunctionality()
        {
            ...
            string firstName = "Prateek Rastogi";
            Console.WriteLine("Value of firstName: {0}", firstName);
            Console.WriteLine("firstName has {0} characters.",firstName.Trim('P','i') );
        ...
        static void StringsAreImmutable()
        {
           ...
           // Console.WriteLine(s1 == upperString);
        ...
        static void FunWithStringBuilder()
        {
            ...
            StringBuilder a = new StringBuilder("Prateek_Rastogi", 250);
            Console.WriteLine(a);
