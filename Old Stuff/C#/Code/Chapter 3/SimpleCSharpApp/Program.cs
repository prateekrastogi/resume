...
namespace SimpleCSharpApp
{
    ...
    class Program
    {
        ...
        static void ShowEnvironmentDetails()
        {
            ...
            Console.SetWindowPosition(0,6);
     
            Console.WriteLine(".NET Version: {0}",Environment.Version);
            Console.WriteLine("Unit: {0}",Console.BufferHeight);
            Console.Title = "Welcome To Kama World";
            Console.WriteLine("Ans:{0}", Console.NumberLock);
