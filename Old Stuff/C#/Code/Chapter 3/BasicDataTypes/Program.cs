...
namespace BasicDataTypes
{
    class Program
    {
        ...
        static void DataTypeFunctionality()
        {
            ...
            Console.WriteLine("Minima of float: {0}",UInt64.MaxValue);
        ...
        static void CharFunctionality()
        {
            ...
            Console.WriteLine("char.IsWhiteSpace('Hello There', 1): {0}",
        ...
        static void UseDatesAndTimes()
        {
            ...
            Console.WriteLine("The day of {0} is {1}", DateTime.Now,DateTime.IsLeapYear(2012));
